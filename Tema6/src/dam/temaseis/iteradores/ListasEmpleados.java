 ...
 * @version 1.0
 */
public class ListasEmpleados implements Iterator{
	...
	public static void main(String[] args) {
		...
		Empleado emp1 = new Empleado("Bicho", "Pelao", "83282348A", LocalDate.parse("2022-02-13"),30);
		Empleado emp2 = new Empleado("Pulga", "Calva", "32942949X", LocalDate.parse("2020-12-11"),40);
		Empleado emp3 = new Empleado("Rana", "Afeitada", "23894823Y", LocalDate.parse("2005-07-28"),21);
		Empleado emp4 = new Empleado("Caballo", "Rapao", "65865495R", LocalDate.parse("2015-05-01"),25);
		listaEmp.add(emp1);
		listaEmp.add(emp2);
		listaEmp.add(emp3);
		listaEmp.add(emp4);
	...
	private static void addEmpJoven() {
	...
	public static void addEmp() {
		...
		listaEmp.add(new Empleado(ListasEmpleados.sc.next()
				, ListasEmpleados.sc.next(), ListasEmpleados.sc.next(), LocalDate.now(), ListasEmpleados.sc.nextInt()));
		System.out.println(listaEmp.toString());
	}
	/**
